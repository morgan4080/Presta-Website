<template>
    <Head title="Contact | Presta Capital" />
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3">
                                ...
                                <div class="relative overflow-hidden py-10 px-6 bg-blue-presta4 sm:px-10 xl:p-12">
                                    ...
                                    <dl class="mt-8 space-y-6">
                                        ...
                                        <dd class="flex text-base text-blue-50">
                                            <MailIcon class="flex-shrink-0 w-6 h-6 text-blue-200" aria-hidden="true" />
                                            <span class="ml-3">support@presta.co.ke</span>
                                        </dd>
                                    </dl>
                                ...
                                <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                    ...
                                    <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                        ...
                                        <div class="sm:col-span-2">
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="subject" id="subject" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-blue-presta3 focus:border-blue-presta3 border-gray-300 rounded-md" />
                                            </div>
                                        </div>
                                        <div class="sm:col-span-2">
                                            <div class="flex justify-between">
                                            ...
                                            <div class="mt-1">
                                                <textarea id="message" name="message" rows="4" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:ring-blue-presta3 focus:border-blue-presta3 border border-gray-300 rounded-md" aria-describedby="message-max" />
                                            </div>
                                        </div>
