<template>
    <div class="bg-white overflow-hidden">
        <div class="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-12 relative">
...
const people = [
    ...
    {
        name: 'Dorothy Lang’at',
        role: 'CX Manager',
        imageUrl:
            '/images/Dorothy-1.png',
        twitterUrl: '#',
        linkedinUrl: '#',
    },
    {
