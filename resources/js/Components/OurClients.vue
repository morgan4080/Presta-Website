<template>
        <div class="my-8">
            <div class="mx-auto max-w-7xl flex flex-col justify-center items-center">
                ...
                <h1 class="text-2xl font-semibold pb-2" >Our Business Patners</h1>
